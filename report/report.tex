...
\begin{document}
    ...
    \section{Idea for a perceptual study}
        ...
        \subsection{Metrics (Questions)}
            ...
            We can give them a questionaire where we ask them how satisfied/disgusted/etc they feel after seeing a simulation, and then they can write what they think the fluid is
